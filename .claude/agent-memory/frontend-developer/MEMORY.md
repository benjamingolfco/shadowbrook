...
- [feedback_rhf_register_ref.md](feedback_rhf_register_ref.md) — Never split form.register() ref into useCallback([], []); use setFocus() for focus-after-reset instead of manual useRef
- [feedback_test_router_wrap.md](feedback_test_router_wrap.md) — Route-param providers need custom wrapper with Routes+Route; don't use test-utils render (double-router error)
