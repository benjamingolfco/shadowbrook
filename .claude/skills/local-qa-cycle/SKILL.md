...
- `/local-qa-cycle` — run a full cycle
- `/local-qa-cycle --headed` — run with visible browser
- `/local-qa-cycle --skip-qa` — skip QA, resume fixing from a previous findings log
