...
namespace Shadowbrook.Api.Migrations
{
    ...
    [Migration("20260302013126_AddGolferAndWaitlistEntry")]
    partial class AddGolferAndWaitlistEntry
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shadowbrook.Api.Models.GolferWaitlistEntry", b =>
                {
                    ...
                    b.HasIndex("CourseWaitlistId", "IsWalkUp", "IsReady");

                    b.ToTable("GolferWaitlistEntries");
                });
            ...
            modelBuilder.Entity("Shadowbrook.Api.Models.WalkUpCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
