...
builder.Services.AddScoped<IDomainEventHandler<Shadowbrook.Domain.WaitlistOfferAggregate.Events.WaitlistOfferAccepted>, Shadowbrook.Api.EventHandlers.WaitlistOfferAcceptedHandler>();
