...
# Integration tests (Teeforce.Api.IntegrationTests) require Docker
...
OUTPUT1=$(dotnet test tests/Teeforce.Domain.Tests 2>&1)
EXIT_CODE1=$?
OUTPUT2=$(dotnet test tests/Teeforce.Api.Tests 2>&1)
EXIT_CODE2=$?
OUTPUT="$OUTPUT1
$OUTPUT2"
